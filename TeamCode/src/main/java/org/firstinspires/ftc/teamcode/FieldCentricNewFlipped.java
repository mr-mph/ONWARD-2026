...
public class FieldCentricNewFlipped extends LinearOpMode {
	...
	public void runOpMode() {
		...
		MecanumDrive drive = new MecanumDrive(hardwareMap, new Pose2d(new Vector2d(0, 0), 90)); // -90 orig
		DcMotorEx intake = hardwareMap.get(DcMotorEx.class,"intake");
		Servo launcher = hardwareMap.get(Servo.class,"launcher");
		Servo stage2 = hardwareMap.get(Servo.class,"stage2");
		Servo stand = hardwareMap.get(Servo.class,"stand");
		...
		startHeading = drive.localizer.getPose().heading.toDouble();
		...
		while (!isStopRequested()) {
			...
			double heading = drive.localizer.getPose().heading.toDouble() - startHeading;
...
//			}
			...
			stand.setPosition(standing ? LaunchConstants.standUp : LaunchConstants.standDefault);
